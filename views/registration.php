    ...
    <div>
        <form name="form" method="post" action="index.php">
            <div class="input-group">
                ...
                <input type="text" name="firstname" class="form-control" placeholder="Введите ваше имя..." aria-describedby="basic-addon1" autofocus required>
            </div> <br>

            <div class="input-group">
                <span class="input-group-addon" id="basic-addon2">Фамилия</span>
                <input type="text" name="lastname" class="form-control" placeholder="Введите вашу фамилию..." aria-describedby="basic-addon2" autofocus required>
            </div> <br>
